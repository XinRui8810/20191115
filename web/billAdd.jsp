...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="${pageContext.servletContext.contextPath}/insertBook.action">
			...
			<table class="box">
			   <tbody><tr>
				...
				<tr>
					...
					<td><input type="text" name="count" class="text" id="productCount" value=""> <font color="red">*</font><font color="red" id="productCount_span"></font></td>
				</tr>
				<tr>
					<td class="field">价&#12288;&#12288;格：</td>
					<td><input name="price" id="billMoney" class="text" value=""><font color="red">*</font><font color="red" id="billMoney_span"></font></td>
				</tr>
			   <tr>
				 ...
				 <tr>
					...
					<td><input type="radio" name="state" value="是">是<input type="radio" name="payed" checked="" value="否">否</td>
				</tr>
			</tbody></table>
		</div>
		<div class="buttons">
